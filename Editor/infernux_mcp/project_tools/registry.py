...
from infernux_mcp.project_tools.loadability import (
...
class ProjectToolRegistry:
    ...
    def register_with_mcp(self, mcp) -> dict[str, Any]:
        from infernux_mcp.tools.common import register_tool_metadata
    ...
    def execute(self, name: str, *args: Any, **kwargs: Any) -> dict[str, Any]:
        from infernux_mcp.tools.common import explain_for, fail, ok
