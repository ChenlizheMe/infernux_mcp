...
from infernux_mcp.project_tools.trace import current_trace, last_trace, list_traces
from infernux_mcp.tools.common import get_tool_metadata, list_tool_metadata, ok, register_tool_metadata
...
def _tool_template(name: str, summary: str) -> str:
    return (
        "from infernux_mcp.project_tools import agent_tool\n\n\n"
