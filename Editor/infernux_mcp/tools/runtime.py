    ...
    def runtime_measure_motion(
        ...
        try:
            if held_keys:
                ...
                from infernux_mcp.tools.input import perform_key_transition
...
def _release_motion_capture_input_on_main(
    ...
    from infernux_mcp.tools import input as input_tools
...
def _motion_capture_worker(capture_id: str) -> None:
    ...
    try:
        ...
        if held_keys or held_mouse_buttons:
            ...
            automation_input_armed = True
            from infernux_mcp.tools.input import perform_key_transition
            from infernux_mcp.tools.input import perform_mouse_button_transition
...
def _read_errors(include_warnings: bool = False, limit: int = 100) -> dict[str, Any]:
    ...
    from infernux_mcp.tools.console import _native_console, _read_native_entries
